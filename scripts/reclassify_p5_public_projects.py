...
MAPPING = {
    ...
    "P5PRJ11": ("T9", "通用主动扫描技术平台", "confocal_endomicroscopy", "robotic_manipulator_arm", "closed_loop_research_platform", "autonomous tissue scanning with live mosaicing and 3D fusion; clinical site unspecified"),
    "P5PRJ12": ("T3", "主动或磁控胶囊内镜", "OCT;endomicroscopy", "magnetic_active_capsule", "closed_loop_research_project", "magnetic navigation and microscopic observation; proposed sampling is a separate task phase"),
}
