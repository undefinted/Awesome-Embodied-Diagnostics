...
Run: `2026-09-21-weekly`; date range: 2026-08-07 to 2026-09-21.

## Denominators

- Source-query records retrieved: 1,936.
- DOI/PMID/arXiv/title-deduplicated candidate records: 1,633.
- Conservative high-signal records: 15.
- Possible-signal records: 284.
- Records retrieved through more than one source family: 104.
- Source-query pairs completed successfully: 112/112.
...
- Records without DOI, PMID, PMCID or arXiv identifier: 33.
